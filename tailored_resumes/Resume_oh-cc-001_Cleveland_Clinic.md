...
**AAPC Certified Professional Coder (CPC) & Former Clinician (BDS) | Certified Medical Coder - Outpatient Specialty**
Ohio, USA | +1(513)886-0280 | saradec182023@gmail.com | AAPC ID: CPC Credentialed

---

## PROFESSIONAL SUMMARY
AAPC Certified Professional Coder (CPC) with a clinical background as a Bachelor of Dental Surgery (BDS) clinician, bringing hands-on diagnostic knowledge to outpatient medical coding, chart abstraction, and clinical documentation review. Thoroughly versed in ICD-10-CM, CPT, and HCPCS Level II coding conventions, Evaluation and Management (E/M) guidelines, NCCI edits, and CMS billing regulations. Experienced in interpreting provider encounter notes, verifying medical necessity, and collaborating across clinical and billing teams to ensure coding completeness and prevent claims rejections. Dedicated to supporting Cleveland Clinic with thorough documentation analysis, accurate code assignment, and compliant revenue cycle practices.

---

## CORE COMPETENCIES & TECHNICAL EXPERTISE
- **Medical & Procedural Coding:** CPT, HCPCS Level II, ICD-10-CM, Evaluation & Management (E/M), Modifiers (25, 59)
- **Regulatory & Healthcare Compliance:** NCCI Edits, CMS Guidelines, HIPAA Privacy Standards, Medical Necessity Guidelines, OIG Compliance, Payer Coverage Policies
...
- **Clinical Documentation & Review:** Anatomic & Pathologic Terminology, Clinical Documentation Improvement (CDI), Chart Auditing & Review, Claim Denial Resolution & Appeals

---

## ACTIVE CERTIFICATIONS & LICENSES
- **Certified Professional Coder (CPC)** – American Academy of Professional Coders (AAPC) (Dayton, Ohio) | Status: **Active** | Credential Date: 10/2025
...
## EDUCATION
- **Bachelor of Dental Surgery (BDS)** – Vishnu Dental College, Andhra Pradesh, India (Graduated: 09/2018)
